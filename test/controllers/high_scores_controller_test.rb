...
class HighScoresControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create high_score" do
    assert_difference('HighScore.count') do
      post high_scores_url, params: { high_score: { player: @high_score.player, score: @high_score.score } }
    end
  ...
  test "should update high_score" do
    patch high_score_url(@high_score), params: { high_score: { player: @high_score.player, score: @high_score.score } }
